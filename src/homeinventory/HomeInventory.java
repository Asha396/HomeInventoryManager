...
public class HomeInventory extends JFrame {
    ...
    ImageIcon new1 = new ImageIcon(ClassLoader.getSystemResource("homeinventory/icons/new.png"));
    Image new2 = new1.getImage().getScaledInstance(25, 25, Image.SCALE_DEFAULT);
    JButton newButton = new JButton(new ImageIcon(new2));

    ImageIcon delete1 = new ImageIcon(ClassLoader.getSystemResource("homeinventory/icons/delete.png"));
    Image delete2 = delete1.getImage().getScaledInstance(25, 25, Image.SCALE_DEFAULT);
    JButton deleteButton = new JButton(new ImageIcon(delete2));

    ImageIcon save1 = new ImageIcon(ClassLoader.getSystemResource("homeinventory/icons/save.png"));
    Image save2 = save1.getImage().getScaledInstance(25, 25, Image.SCALE_DEFAULT);
    JButton saveButton = new JButton(new ImageIcon(save2));

    ImageIcon previous1 = new ImageIcon(ClassLoader.getSystemResource("homeinventory/icons/previous.jpg"));
    Image previous2 = previous1.getImage().getScaledInstance(25, 25, Image.SCALE_DEFAULT);
    JButton previousButton = new JButton(new ImageIcon(previous2));

    ImageIcon next1 = new ImageIcon(ClassLoader.getSystemResource("homeinventory/icons/next.png"));
    Image next2 = next1.getImage().getScaledInstance(25, 25, Image.SCALE_DEFAULT);
    JButton nextButton = new JButton(new ImageIcon(next2));

    ImageIcon print1 = new ImageIcon(ClassLoader.getSystemResource("homeinventory/icons/print.png"));
    Image print2 = print1.getImage().getScaledInstance(25, 25, Image.SCALE_DEFAULT);
    JButton printButton = new JButton(new ImageIcon(print2));
    ...
    public HomeInventory() {
        ...
        dateDateChooser.addPropertyChangeListener((PropertyChangeEvent e) -> {
        ...
        for (int i = 0; i < 26; i++) {
            ...
            searchButton[i].addActionListener((ActionEvent e) -> {
        ...
        try {
            ...
            numberEntries = Integer.valueOf(inputFile.readLine());
            if (numberEntries != 0) {
                for (int i = 0; i < numberEntries; i++) {
                    ...
                    myInventory[i].marked = Boolean.valueOf(inputFile.readLine());
            ...
            n = Integer.valueOf(inputFile.readLine());
            if (n != 0) {
                for (int i = 0; i < n; i++) {
    ...
    private void exitForm(WindowEvent evt) {
        ...
        try {
            PrintWriter outputFile = new PrintWriter(new BufferedWriter(new FileWriter("inventory.txt", true)));
...
// display entry j (1 to numberEntries)
        ...
        dateDateChooser.setDateFormatString(myInventory[j - 1].purchaseDate);   //.setDate(stringToDate(myInventory[j - 1].purchaseDate));
    ...
    private String dateToString(Date dd) {
        String strDate = "Jan 01, 2000";
        DateFormat dateFormat = new SimpleDateFormat("MMM dd, yyyy");
        strDate = dateFormat.format(dd);
        return strDate;
    }
